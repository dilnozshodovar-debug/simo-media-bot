...
BTN = {
    "tj": {
        ...
        "services": "🎬 Хизматрасониҳои иловагӣ", "back_services": "⬅️ Ба хизматрасониҳо",
        "order_service": "✅ Ин хизматро фармоиш медиҳам",
    ...
    "ru": {
        ...
        "services": "🎬 Дополнительные услуги", "back_services": "⬅️ К услугам",
...
TEXT = {
    ...
    "services_title": {
        "tj": ("🎬 <b>ХИЗМАТРАСОНИҲОИ ИЛОВАГИИ SIMO.MEDIA</b>\n━━━━━━━━━━━━━━━━━━\n\n"
               "Ба ғайр аз наворбардории тӯй, мо боз ин хизматҳоро низ пешниҳод мекунем 👇"),
        "ru": ("🎬 <b>ДОПОЛНИТЕЛЬНЫЕ УСЛУГИ SIMO.MEDIA</b>\n━━━━━━━━━━━━━━━━━━\n\n"
               "Помимо свадебной съёмки, мы также предлагаем эти услуги 👇"),
    },
    "portfolio_title": {
    ...
    "service_order_accepted": {
        "tj": "✅ <b>Дархости шумо қабул шуд!</b>",
        "ru": "✅ <b>Ваша заявка принята!</b>",
    },
    "service_order_thanks": {
        "tj": "Мутахассиси мо ба наздикӣ бо шумо тамос гирифта, ҷузъиёти хизматро муҳокима мекунад. Ташаккур! 🙏",
        "ru": "Наш специалист скоро свяжется с вами, чтобы обсудить детали услуги. Спасибо! 🙏",
    },
    "after_hours_note": {
...
SERVICES = {
    "lovestory": {
        "title": {"tj": "❤️ Love Story", "ru": "❤️ Love Story"},
        "text": {
            ...
            "ru": ("❤️ <b>Love Story (Романтическая фотосессия)</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   ...
                   "Мы подготовим для вас романтическую фотосессию с творческими идеями, "
                   "красивыми локациями и профессиональной обработкой фото. Для предложения "
                   "руки и сердца, до свадьбы, после свадьбы или просто чтобы сохранить тёплые "
                   "моменты жизни.\n\n"
                   "✨ Естественные фото • Профессиональная обработка • Высокое качество"),
        },
    },
    "print": {
        "title": {"tj": "🖼 Чопи аксҳо", "ru": "🖼 Печать фото"},
        "text": {
            "tj": ("🖼 <b>Чопи аксҳо</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Хотираҳоро танҳо дар телефон нигоҳ надоред!\n\n"
                   "Аксҳои худро бо сифати баланд чоп намуда, ҳамчун туҳфа ё ороиши хона ва "
                   "идора истифода баред.\n\n"
                   "📏 Андозаҳои гуногун • Рангҳои зинда • Коғази босифат"),
            "ru": ("🖼 <b>Печать фото</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Не храните воспоминания только в телефоне!\n\n"
                   "Распечатаем ваши фото в высоком качестве — используйте их как подарок или "
                   "украшение дома и офиса.\n\n"
                   "📏 Разные размеры • Яркие цвета • Качественная бумага"),
        },
    },
    "portrait": {
        "title": {"tj": "🎨 Портретҳо", "ru": "🎨 Портреты"},
        "text": {
            "tj": ("🎨 <b>Портретҳо</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Наздикони худро бо як туҳфаи махсус шод гардонед.\n\n"
                   "Мо аз акси шумо портретҳои зебо дар андозаҳои 20×30 то 60×90 омода "
                   "менамоем.\n\n"
                   "🎁 Беҳтарин туҳфа барои зодрӯз, солгарди издивоҷ ва дигар ҷашнҳо."),
            "ru": ("🎨 <b>Портреты</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Порадуйте близких особенным подарком.\n\n"
                   "Мы изготовим красивые портреты по вашему фото в размерах от 20×30 до "
                   "60×90.\n\n"
                   "🎁 Лучший подарок на день рождения, годовщину свадьбы и другие праздники."),
        },
    },
    "ai_video": {
        "title": {"tj": "🤖 Видеоҳои табрикотӣ бо AI", "ru": "🤖 AI-видеопоздравления"},
        "text": {
            "tj": ("🤖 <b>Видеоҳои табрикотӣ бо AI</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Табрикоте, ки ҳама аз он ҳайрон мешаванд!\n\n"
                   "Бо истифода аз технологияҳои зеҳни сунъӣ (AI) барои шумо видеоҳои "
                   "табрикотии ҷолиб ва замонавӣ таҳия мекунем.\n\n"
                   "🎉 Барои зодрӯз • Тӯй • Хатми мактаб • Ҷашнҳо • Ширкатҳо"),
            "ru": ("🤖 <b>AI-видеопоздравления</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Поздравление, которое всех удивит!\n\n"
                   "С использованием технологий искусственного интеллекта (AI) создадим для "
                   "вас яркие и современные видеопоздравления.\n\n"
                   "🎉 На день рождения • Свадьбу • Выпускной • Праздники • Для компаний"),
        },
    },
    "ad_video": {
        "title": {"tj": "📢 Роликҳои рекламавӣ", "ru": "📢 Рекламные ролики"},
        "text": {
            "tj": ("📢 <b>Роликҳои рекламавӣ</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Бизнеси худро бо рекламаи касбӣ муаррифӣ кунед.\n\n"
                   "Мо барои бренд, мағоза, тарабхона, маркази хизматрасонӣ ва дигар "
                   "соҳибкорон роликҳои ҷолиби рекламавӣ омода мекунем.\n\n"
                   "📈 Рекламаи хуб = Мизоҷони бештар"),
            "ru": ("📢 <b>Рекламные ролики</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Представьте свой бизнес с профессиональной рекламой.\n\n"
                   "Создадим яркие рекламные ролики для бренда, магазина, ресторана, сервисного "
                   "центра и других предпринимателей.\n\n"
                   "📈 Хорошая реклама = Больше клиентов"),
        },
    },
    "ad_shoot": {
        "title": {"tj": "🎥 Наворбардории реклама", "ru": "🎥 Рекламная съёмка"},
        "text": {
            ...
            "ru": ("🎥 <b>Рекламная съёмка</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Снимем ваш продукт или услугу профессиональными камерами и современным "
                   "оборудованием.\n\n"
                   "✨ Качественное видео для Instagram, TikTok, Facebook и YouTube."),
        },
    },
    "concert": {
        "title": {"tj": "🎤 Наворбардорӣ ва монтажи клипу консертҳо", "ru": "🎤 Съёмка клипов и концертов"},
        "text": {
            "tj": ("🎤 <b>Клип ва консерт</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Наворбардорӣ ва монтажи касбии:\n"
                   "🎵 Клипҳои мусиқӣ\n🎙 Консертҳо\n🎉 Чорабиниҳо\n🎓 Маросимҳо\n\n"
                   "Бо сифати баланд ва услуби муосир."),
            "ru": ("🎤 <b>Клипы и концерты</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   "Профессиональная съёмка и монтаж:\n"
                   "🎵 Музыкальных клипов\n🎙 Концертов\n🎉 Мероприятий\n🎓 Церемоний\n\n"
                   "С высоким качеством и в современном стиле."),
        },
    },
    "edit": {
        "title": {"tj": "🎬 Ҳама намудҳои монтажи видео", "ru": "🎬 Монтаж видео"},
        "text": {
            "tj": ("🎬 <b>Монтажи видео</b>\n━━━━━━━━━━━━━━━━━━\n\n"
            ...
            "ru": ("🎬 <b>Монтаж видео</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                   ...
                   "✔️ Instagram Reels\n✔️ TikTok\n✔️ YouTube\n✔️ Рекламные видео\n"
                   "✔️ Свадебные видео и мероприятия\n✔️ Цветокоррекция\n"
...
def services_menu_kb(lang: str):
    kb = [[InlineKeyboardButton(svc["title"][lang], callback_data=f"svc_{key}")] for key, svc in SERVICES.items()]
    kb.append([InlineKeyboardButton(BTN[lang]["back"], callback_data="menu_main")])
    return InlineKeyboardMarkup(kb)


def service_detail_kb(svc_key: str, lang: str):
    b = BTN[lang]
    kb = [
        [InlineKeyboardButton(b["order_service"], callback_data=f"choose_svc_{svc_key}")],
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu_main":
        ...
        svc_key = data[len("svc_"):]
        svc = SERVICES.get(svc_key)
        if svc:
            await safe_edit(query, svc["text"][lang], service_detail_kb(svc_key, lang))
...
async def choose_package_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.answer()
    lang = get_lang(context)
    key = query.data[len("choose_"):]

    if key.startswith("svc_"):
        svc_key = key[len("svc_"):]
        svc = SERVICES.get(svc_key)
        if not svc:
            return ConversationHandler.END
        context.user_data["order_pkg"] = {"short": svc["title"][lang]}
        context.user_data["is_service"] = True
    else:
        pkg = PACKAGES.get(key)
        if not pkg:
            return ConversationHandler.END
        context.user_data["order_pkg"] = pkg
        context.user_data["is_service"] = False
...
async def ask_phone(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("is_service"):
        return await finalize_service_order(update, context)
...
async def finalize_service_order(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    context.bot_data.setdefault("orders", {})[order_number] = {
        ...
        "name": name, "phone": phone, "date": "—", "status": "🆕 Нав", "prepay": False,
    }
    ...
    for admin_id in ADMIN_IDS:
        try:
            sent_msg = await context.bot.send_message(
                ...
                text=(
                    "🆕 <b>ДАРХОСТИ ХИЗМАТ!</b>\n━━━━━━━━━━━━━━━━━━\n\n"
                    f"🔖 Рақам: <b>{order_number}</b>\n"
                    f"🎬 Хизмат: {pkg.get('short', '—')}\n"
                    f"👤 Ном: {name}\n📱 Телефон: {phone}\n\n"
    ...
    context.user_data.pop("is_service", None)
    return ConversationHandler.END
